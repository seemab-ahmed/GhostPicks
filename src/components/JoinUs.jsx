    ...
    <section className="py-10 xl:py-20">
      <div className="container">
        ...
        >
          ...
          <Link
            to="/"
            className="text-sm font-semibold text-jaguar shadow-custom-white-three leading-none h-12 xl:h-[58px] flex items-center justify-center px-8 rounded-[50px] capitalize bg-custom-mint border border-[rgba(200,255,206,0.7)] max-w-[180px] xl:max-w-[248px] w-full mx-auto"
          >
            Join Discord
          </Link>
        </div>
