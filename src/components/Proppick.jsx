...
import PlayerImg from "../assets/images/kingz.png";
...
const Proppick = () => {
  ...
  return (
    <section className="pt-10 pb-10 xl:pb-20">
      <div className="container">
        <div className="flex flex-col lg:flex-row gap-5 xl:gap-0 max-w-[540px] lg:max-w-full mx-auto items-end">
          <div
          ...
          >
            <h2 className="text-heading2 max-w-[593px] w-full text-left">
              How to get a <span className="text-saffronMango">Kingz</span>{" "}
              bankroll
            </h2>
            <p className="text-body mb-5 xl:mb-10 max-w-[460px] w-full text-left">
            ...
            <img
              src={PlayerImg}
              alt="player"
              className="absolute right-0 bottom-0 -z-[1] max-w-[180px] lg:max-w-[220px] xl:max-w-[448px] w-full"
            />
          </div>
          <div
          ...
          >
            ...
            <div className="rounded-[40px] bg-custom-mango-gradient p-4 md:p-6 xl:p-10 -mt-16 relative border border-border-transparent-white">
              <div className="rounded-[20px] p-3 md:p-5 xl:p-[30px] border border-custom-transparent-white bg-custom-gradient-one">
                <ul className="grid grid-cols-3 gap-2.5 mb-5 xl:mb-8 bg-[#0C0D0B] p-1 rounded-[50px]">
                  {tabs.map((tab, index) => (
                    <li
                      key={index}
                      onClick={() => setActiveTab(index)}
                      className={`text-xs xl:text-sm font-semibold text-saffronMango leading-none h-10 md:h-12 xl:h-[58px] flex items-center justify-center md:px-2 rounded-[50px] capitalize cursor-pointer border border-custom-transparent-white ${
                        activeTab === index
                          ? "bg-saffronMango-radial-gradient"
                ...
                <div className="border border-custom-transparent-white bg-[#020B03] rounded-xl p-5">
                  <div className="mb-5">
                    ...
                    <div class="w-full bg-custom-gradient-two border border-[rgba(255,255,255,0.01)] rounded-full h-5 xl:h-[30px] shadow-custom-white-four">
